...
#                  with Hadoop 2.
HADOOP_CONF_DIR=$HOME/softwares/hadoop
...
PIO_STORAGE_SOURCES_MYSQL_URL=jdbc:mysql://127.0.0.1/pio
...
# PIO_STORAGE_SOURCES_ELASTICSEARCH_HOME=$HOME/softwares/elasticsearch
