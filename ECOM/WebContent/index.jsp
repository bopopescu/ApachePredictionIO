							...
							<div class="sap_tabs">	
								<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
										<div class="facts">
											<div class="register">
												<form id="signupform" method="post" action="Servlet" enctype="multipart/form-data">			
							...
							<script type="text/javascript">
								$(document).ready(function () {
									...
									$("#signupform").submit(function(e){
										e.preventDefault();
									    $.ajax({
										url: "/ECOM/Servlet?method=usersignup",
										type: "GET",
										data: $("#signupform").serialize(),//new FormData(document.getElementById("signupform")),
...
//	        alert(sessioncheck);
	...
	<div class="header" id="home1">
		<div class="container">
			<div id = "loginbtn" class="w3l_login">
