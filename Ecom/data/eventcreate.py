...
def import_events(client):
 ...
 item_ids = {'Mobile Phone1','Mobile Phone2','Mobile Phone3','Smart Phone','Wireless Phone','Speakers','Headphone','Audio Player','Audio-speaker','Laptop','Notebook','Kids Toy','Refrigerator','LED Tv','Washing Machine','Grinder','Water Purifier','Coffee Maker','Wireless Speaker','Red Mobile','Wireless Phone','Golden Tablet','Asus Tablet'} 
